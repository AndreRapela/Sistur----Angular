...
export const routes: Routes = [
  ...
  { path: 'pontos-turisticos', loadComponent: () => import('./pages/tourist-points/tourist-points').then(m => m.TouristPointsComponent), canActivate: [roleGuard(allUserRoles)], data: { preload: true, preloadDelay: 1800 } },
  ...
  { path: 'tours', loadComponent: () => import('./pages/tour-list/tour-list').then(m => m.TourListComponent), canActivate: [roleGuard(allUserRoles)], data: { preload: true, preloadDelay: 2200 } },
  { path: 'restaurants', loadComponent: () => import('./pages/establishment-list/establishment-list').then(m => m.EstablishmentListComponent), canActivate: [roleGuard(allUserRoles)], data: { preload: true, preloadDelay: 1600 } },
  ...
  { path: 'map', loadComponent: () => import('./pages/map-page/map-page').then(m => m.MapPageComponent), canActivate: [roleGuard(allUserRoles)], data: { preload: true, preloadDelay: 900 } },
  { path: 'conveniencias', loadComponent: () => import('./pages/map-page/map-page').then(m => m.MapPageComponent), canActivate: [roleGuard(allUserRoles)] },
  { path: 'itinerary', loadComponent: () => import('./pages/itinerary/itinerary').then(m => m.ItineraryPageComponent), canActivate: [roleGuard(allUserRoles)], data: { preload: true, preloadDelay: 2600 } },
